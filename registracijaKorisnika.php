...
if (isset($_POST['registracija'])) {
	...
	$NoviKorisnik->Registracija($_POST['ime'],$_POST['prezime'],$_POST['email'],$_POST['telefon'],$_POST['username'],$_POST['password'],$_POST['status']);
...
<h1>Registracija</h1>
		<div class="obavestenje" > <strong id="obavestenje" ><?php echo $t;?></strong></div><br/>
		 <form id="form" class="form-horizontal" method="POST" action="registKorisnika.php" onsubmit="return Validacija()">
...
<div class="form-group">
              ...
              <div class="form-group">
                ...
                <div class="col-sm-8">
                  <input type="password" class="form-control" name="password" placeholder="Unesite šifru..." id="password">
                </div>
              </div>
              <div class="form-group">
              
                <div class="col-sm-8">
                  <input type="text" class="form-control" name="status" value="Korisnik" id="status" readonly style="display:none;">
                </div>              </div>


		<button type="submit" name="registracija" class="btn btn-success">Sačuvaj</button>
    <br><br><br><br><br>
